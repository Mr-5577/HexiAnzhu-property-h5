<template>
	<view class="housekeeper">
		...
		<view class="header">
			<view class="avatar">
				<image :src="housekeeper.hpath ? '/static/images/avatar.png' : '/static/images/avatar.png'"
				...
				<view class="eval-item" v-for="(item, index) in userViews" :key="index">
					...
					<view class="intro-wrapper">
						<view class="introduce">
							...
							<view class="rate"><uni-rate :readonly="true" :value="item.score" :size="16" :margin="5" />
							</view>
						</view>
			...
			<view class="service-area" v-if="current == 1">
				...
				<view v-else>
					<view class="adr-wrapper">
						...
						<text
							class="title">{{ housekeeper.villageinfo ? housekeeper.villageinfo.villagename : '无项目名' }}</text>
					</view>
					<view class="b-wrapper">
						<view class="b-item" v-for="(item, index) in housekeeper.servicearea" :key="index">{{ item }}
						</view>
					</view>
				</view>
			</view>
